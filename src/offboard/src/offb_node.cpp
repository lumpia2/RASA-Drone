...
int main(int argc, char **argv)
{
    ...
    geometry_msgs::PoseStamped takeoff, land, forward, back;
    
    takeoff.pose.position.x = 0;
    takeoff.pose.position.y = 0;
    takeoff.pose.position.z = 2;

    land.pose.position.x = 0; 
    land.pose.position.y = 0; 
    land.pose.position.z = 0; 

    forward.pose.position.x = 2;
    forward.pose.position.y = 0; 
    forward.pose.position.z = 2; 
